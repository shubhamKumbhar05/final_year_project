...
export default function FramingConceptViz() {
  ...
  useEffect(() => {
    ...
    overlayRoot.style.zIndex = '1200'
    overlayRoot.style.pointerEvents = 'none'
    document.body.appendChild(overlayRoot)

    overlayRootRef.current = overlayRoot
    htmlPortalRef.current = { current: overlayRoot }
    setIsOverlayReady(true)

    return () => {
      setIsOverlayReady(false)
      htmlPortalRef.current = null
  ...
  return (
    <group>
      ...
      {isOverlayReady && htmlPortalRef.current && (
      <Html portal={htmlPortalRef.current} fullscreen style={{ pointerEvents: 'none' }}>
