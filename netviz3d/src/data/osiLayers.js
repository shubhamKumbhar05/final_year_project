...
export const OSI_LAYERS = [
  {
    ...
    concepts: [
      ...
      },
      {
        id: 'app-https',
        name: 'HTTPS',
        meaning: 'HTTP Secure with TLS/SSL encryption',
        example: 'Secure browser connection (port 443)',
        visualGoal: 'Show TLS handshake and encrypted transmission',
      },
      {
        id: 'app-dns',
        name: 'DNS',
      ...
      },
      {
        id: 'app-telnet',
        name: 'Telnet',
        meaning: 'Remote terminal protocol for command-line access',
        example: 'Connecting to a remote host over port 23',
        visualGoal: 'Show remote terminal session, login, and command exchange',
      },
    ],
  },
  {
